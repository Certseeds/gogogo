...
(
    ...
    `from` BIGINT(20) NOT NULL COMMENT 'follow关系的关注者,为github_user内的id',
    `to`   BIGINT(20) NOT NULL COMMENT 'follow关系的关注者,为github_user内的id',
    PRIMARY KEY (`id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
    UNIQUE INDEX `connection_UNIQUE` (`from`, `to`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
